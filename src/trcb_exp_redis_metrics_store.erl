...
-module(trcb_exp_redis_metrics_store).
-author("Georges Younes <georges.r.younes@gmail.com").

-include("trcb_exp.hrl").

-behaviour(gen_server).
-behaviour(trcb_exp_metrics_store).

%% trcb_exp_metrics_store callbacks
-export([start_link/0,
         put/2]).
...
init([]) ->
    ...
    ?LOG("trcb_exp_redis_metrics_store initialized"),
...
%% @private
get_redis_config() ->
    case trcb_exp_orchestration:get_task(redis, ?REDIS_PORT, false) of
        {ok, {_, IpAddress, Port}} ->
